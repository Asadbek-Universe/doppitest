import{a as o,g as c,h as i,s as t}from"./index-BNvuaRBA.js";const y=()=>o({queryKey:["subjects"],queryFn:async()=>{const{data:e,error:r}=await t.from("subjects").select("*").order("name",{ascending:!0});if(r)throw r;return e}}),d=e=>o({queryKey:["courses",e],queryFn:async()=>{let r=t.from("courses").select(`
          *,
          subjects (
            id,
            name,
