-- Create center in trigger when app_role=center so center signup works with email confirmation (no session yet).
-- Reads center_name and center_email from signUp options.data (raw_user_meta_data).
